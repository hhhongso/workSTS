...
<meta property="og:url" content="https://www.kurly.com/shop/goods/goods_list.php?category=907001" />
...
<script type="text/javascript" src="https://res.kurly.com/js/lib/jquery-1.10.2.min.js?ver=20191028193326"></script>
<link rel="shortcut icon" href="https://res.kurly.com/images/marketkurly/logo/favicon_v2.png" type="image/x-icon">
<script>
var jwtToken = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..33fYRJz_K057JfVLuCDKCo8z93tjM_mzCLjqI-9oYvk';
var apiDomain = 'https://api.kurly.com';
var GD_ISMEMBER = !!Number('1');
var checkIsApp = true;// 해당스크립트관련으로 앱체크공용변수추가 생성.앱에서 불필요한 호출제거
</script>
<script src="https://ssl.daumcdn.net/dmaps/map_js_init/postcode.v2.js?ver=20191028193326"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/thefarmers.js?ver=20191028193326"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/common.js?ver=20191028193326"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/polify.js?ver=20191028193326"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/ui_v2.js?ver=20191028193326"></script>
<script src="https://res.kurly.com/js/lib/jquery.lazyload.min.js?ver=20191028193326"></script>

<script src="//res.kurly.com/js/vue/xdomain.min.js" slave="https://api.kurly.com/xdomain"></script>

<script src="//res.kurly.com/js/vue/es6-promise.min.js?ver=20191028193326"></script>
<script src="//res.kurly.com/js/vue/es6-promise.auto.min.js?ver=20191028193326"></script>

<script type="text/javascript" src="//res.kurly.com/js/vue/axios.min.js?ver=20191028193326"></script>


<script src="//res.kurly.com/js/vue/vue.min.js?ver=20191028193326"></script>
<script src="https://www.kurly.com/common_js/axios.js?ver=20191028193326"></script>
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/normalize.css?ver=20191028193326">
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/section1.css?ver=20191028193326">
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/common.css?ver=20191028193326">

<script type="text/javascript" src="//wcs.naver.net/wcslog.js"></script>
<script type="text/javascript" src="https://www.kurly.com/shop/lib/js/naverCommonInflowScript.js?Path=goods/goods_list.php&amp;Referer=&amp;AccountID=s_4f41b5625072&amp;Inflow=kurly.com" id="naver-common-inflow-script"></script>
...
window.criteo_q.push(
    ...
    { event: "viewList", item: "907001", requiresDOM: "yes" }
);
</script>
...
<body class="goods-goods_list" oncontextmenu="return false" ondragstart="return false" onselectstart="return !enableSelection">
...
<script src="/common_js/usermenu_v1.js?ver=20191028193326"></script>
<script>
$(document).ready(function(){
...
<script src="/common_js/gnb_v1.js?ver=20191028193326"></script>
<script type="text/javascript">
//
gnbMenu.getCategoryNum = '907001';
gnbMenu.update();
...
<li>
<a href="/shop/goods/goods_view.php?&goodsno=42474" class="link_goods">
<img src='//img-cf.kurly.com/shop/data/goods/1571735556581s0.jpg' class="lastview-menu-item-image" onerror=this.src='/shop/data/skin/designgj/img/common/noimg_100.gif' />
</a>
</li>
</ul>
</div>
...
<a class="link_event" href="#none">페이지 이동</a>
</div>
<div class="inner_lnb">
<div class="ico_cate">
<span class="ico"><img src="https://res.kurly.com/pc/img/1808/bg_blink_120_91.png" id="goodsListIconView" alt="카테고리 아이콘"></span>
<span class="tit" v-html="categoryName"></span>
</div>
<ul class="list">
<lnb-menu v-for="(menu, idx) in categoryMenu" :key="'menu'+idx" :item="menu" :idx="idx" :length-check="categoryMenu.length" :type="type" :category-name="categoryName" @menu-scroll="menuScroll" @lnb-checked="lnbChecked"></lnb-menu>
<li class="bg"></li>
</ul>
</div>
</div>
...
<ul class="list">
<list-goods v-for="(goods, idx) in goodsItem" v-if="!noData" :get-category-num="getCategoryNum" :key="'goods'+idx" :idx="idx" :item="goods" :tag-name="goods.tags.names" :tag-type="goods.tags.tagType" :sort-delivery="sortDelivery" :sort-user="sortUser" :type="type"></list-goods>
</ul>
</div>
</div>
...
<script src="/common_js/common_filter.js?ver=20191028193326"></script>
<script src="/common_js/goodslist_v1.js?ver=20191028193326"></script>
<script type="text/javascript">
$(document).ready(function(){
    var categoryNo = null;
    if(sessionStorage.goodsListReferrer && sessionStorage.goodsListReferrer === 'goodsView'){
        ...
        if(sessionStorage.gListCategoryNo && '907001' != '029' && '907001' != '038'){
...
<script src="/common_js/cartput_v1.js?ver=20191028193326"></script>
<script>
	// 클릭인인경우
