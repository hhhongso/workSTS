...
<script type="text/javascript" src="https://res.kurly.com/js/lib/jquery-1.10.2.min.js?ver=20191028191822"></script>
...
<script src="https://ssl.daumcdn.net/dmaps/map_js_init/postcode.v2.js?ver=20191028191822"></script>
<script src="/shop/data/skin/designgj/thefarmers.js?ver=20191028191822"></script>
<script src="/shop/data/skin/designgj/common.js?ver=20191028191822"></script>
<script src="/shop/data/skin/designgj/polify.js?ver=20191028191822"></script>
<script src="/shop/data/skin/designgj/ui_v2.js?ver=20191028191822"></script>
<script src="https://res.kurly.com/js/lib/jquery.lazyload.min.js?ver=20191028191822"></script>

<script src="//res.kurly.com/js/vue/xdomain.min.js" slave="https://api.kurly.com/xdomain"></script>

<script src="//res.kurly.com/js/vue/es6-promise.min.js?ver=20191028191822"></script>
<script src="//res.kurly.com/js/vue/es6-promise.auto.min.js?ver=20191028191822"></script>

<script type="text/javascript" src="//res.kurly.com/js/vue/axios.min.js?ver=20191028191822"></script>


<script src="//res.kurly.com/js/vue/vue.min.js?ver=20191028191822"></script>
<script src="/common_js/axios.js?ver=20191028191822"></script>
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/normalize.css?ver=20191028191822">
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/section1.css?ver=20191028191822">
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/common.css?ver=20191028191822">
...
<script src="/common_js/usermenu_v1.js?ver=20191028191822"></script>
<script>
$(document).ready(function(){
...
<script src="/common_js/gnb_v1.js?ver=20191028191822"></script>
<script type="text/javascript">
//
gnbMenu.update();
...
<div>
<div class="inner_popdiv">
<strong class="tit">비밀번호 변경</strong>
<hr class="line">
<div class="wrap_pw">
<p class="desc">고객님의 개인 정보를 보호하고, 피해를 예방하기 위하여 비밀번호 변경을 안내드립니다.</p>
<dl>
<dt class="inp_tit">현재 비밀번호</dt>
<dd>
<div class="wrap_inp">

<input type="password" id="pwOrigin" name="pwOrigin" class="pw_inp" value="" autocomplete="off" maxlength="50">
<label for="pwOrigin" class="txt_placeholder">현재 비밀번호를 입력해주세요.</label>
<div class="mark_valid">
<ul>
<li class="mark_invalid_etc"></li>
</ul>
</div>
</div>
</dd>
</dl>
<dl class="new_pw info_password">
<dt class="inp_tit">새 비밀번호</dt>
<dd>
<div class="wrap_inp">
<input type="password" id="pwNew" name="pwNew" class="pw_inp " value="" maxlength="50">
<label for="pwNew" class="txt_placeholder">새 비밀번호를 입력해주세요.</label>
<div class="mark_valid">
<ul>
<li class="mark_diff">현재 비밀번호와 다르게 입력</li>
<li class="mark_length">10자 이상 입력</li>
<li class="mark_mix">영문/숫자/특수문자(공백 제외)만 허용하며, 2개 이상 조합</li>
<li class="mark_numbers">동일한 숫자 3개 이상 연속 사용 불가</li>
</ul>
</div>
</div>
</dd>
<dt class="inp_tit">새 비밀번호 확인</dt>
<dd>
<div class="wrap_inp">
<input type="password" id="pwNewConfirm" name="pwNewConfirm" class="pw_inp " value="" maxlength="50">
<label for="pwNewConfirm" class="txt_placeholder">새 비밀번호를 한번 더 입력해주세요.</label>
<span class="mark_valid mark_coincide">새 비밀번호와 동일한 비밀번호 입력</span>
</div>
</dd>
</dl>
<hr class="line_grey">
<p class="pw_notice">
고객님의 개인 정보를 보호하고, 피해를 예방하기 위하여 비밀번호 변경을 안내드립니다. 현재 비밀번호 변경을 원하지 않을 경우 '다음에 변경하기' 버튼을 누르면 180일 이후 다시 안내드립니다.
</p>
</div>
<div class="btn_group">
<a href="#C" target="ifrmHidden" class="btn btn_close">다음에 변경하기</a>
<a href="#C" class="btn link_move">변경하기</a>
</div>
</div>
</div>
</div>
<script src="/shop/data/skin/designgj/js/pw_validate.js?ver=20191028191822"></script>

</div>
<script src="/common_js/main_notice_v1.js?ver=20191028191822"></script>
<script>
    mainNotice.type='pc';
</script>
...
<script src="/common_js/common_filter.js?ver=20191028191822"></script>
<script src="/common_js/main_v1.js?ver=20191028191822"></script>
<script>
$(document).ready(function(){
    kurlyMain.type = 'pc';
    kurlyMain.update();
