...
<form name="imageboardWriteForm" method="post" enctype="multipart/form-data" action="/springProject/imageboard/imageboardWrite">
	<table border=3>
		<tr>
			<th>상품코드</th>
		...
		<tr>
			<td colspan=2 align="center">
				<input type="button" value="이미지 등록" class="btnImageWrite" onclick="checkImageboard()">
