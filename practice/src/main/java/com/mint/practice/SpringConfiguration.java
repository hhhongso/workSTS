...
public class SpringConfiguration {
	...
	//	sqlSessionFactoryBean.setConfigLocation(new ClassPathResource("spring/mybatis-config.xml"));
		...
		sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("com/sample/websocket/dao/courseMapper.xml"));
